...
Changing registrars is a bit more complicated for me, because I had private registration. I first needed to remove this feature, exposing my true whereabouts, before I was allowed to change registrars. I had to according to both NFS and Godaddy. I'm not sure if this is a necessary thing when changing registrars, but it defeats the purpose of private registration.
